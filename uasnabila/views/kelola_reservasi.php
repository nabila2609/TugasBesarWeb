...
if (isset($_POST['tambah_reservasi'])) {
    ...
    $stmt = $koneksi->prepare("INSERT INTO nabila_reservasi (id_users, id_paket, tanggal_acara, jumlah_tamu, lokasi, status) VALUES (?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("iissss", $id_users, $id_paket, $tanggal_acara, $jumlah_tamu, $lokasi, $status);
    if ($stmt->execute()) {
